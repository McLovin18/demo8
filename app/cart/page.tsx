...
export default function CartPage() {
  ...
  const handleGenerarOrden = async () => {
    ...
    const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_PHONE || "593994361621";
  ...
  const EmptyCart = () => (
    <div className="flex flex-col items-center justify-center py-20 gap-4 text-center">
      ...
      <a
        ...
        className="mt-2 inline-flex items-center gap-2 text-white bg-black border border-white/15 hover:border-[#2D4A3A] hover:shadow-md font-semibold px-6 py-2.5 rounded-xl transition-colors shadow"
      >
    ...
    <>
      <div className="min-h-screen text-white transition-colors">
        <main className="max-w-6xl mx-auto px-3 sm:px-6 py-6 sm:py-10">
          ...
          {error && (
            <div className="flex items-start gap-2 bg-red-600/10 border border-red-600/40 text-[#2D4A3A] rounded-xl px-4 py-3 text-sm mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
              <div className="lg:col-span-2 space-y-3">
                {carrito.map((p) => {
                  ...
                  return (
                    <div
                      key={itemKey}
                      className="bg-black rounded-2xl border border-[#2D4A3A] shadow-sm p-4 flex gap-3 sm:gap-4 items-start"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                          ...
                          {hasDiscount && (
                            <span className="text-[10px] font-bold bg-[#C2477D]/10 text-[#2D4A3A] px-1.5 py-0.5 rounded-full">
                              -{discount}%
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex flex-col items-end justify-between h-full gap-3 shrink-0">
                        ...
                        <button
                          ...
                          className="text-[var(--textSecondary)] hover:text-[#2D4A3A] transition-colors"
                          title="Eliminar"
                        >
                ...
                <a
                  href="/products-by-category"
                  className="inline-flex items-center gap-1.5 text-sm text-white hover:text-[#2D4A3A] hover:underline mt-1 transition-colors"
                >
              ...
              <div className="lg:col-span-1">
                <div className="bg-[#0a0a0a] rounded-2xl border border-white/10 shadow-md p-5 md:sticky md:top-20 space-y-4">
                    ...
                    <div className="border-t border-[#2D4A3A] mt-3 pt-3 flex justify-between font-bold text-base">
                  ...
                  <div className="space-y-2.5">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-3.5 px-6 bg-[#2D4A3A] hover:bg-[#2D4A3A] text-white font-extrabold text-sm rounded-xl transition-colors shadow-md"
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-3.5 px-6 bg-black border border-white/15 hover:border--[#2D4A3A] text-white font-bold text-sm rounded-xl transition-colors"
